        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    " <table class=\"table tree-grid  table-bordered table-striped \">\n" +
                    ...
                    "       <td style='vertical-align: middle;' width='60px'  class='form-inline'><a ng-click=\"user_clicks_branch(row.branch)\"><i ng-class=\"row.tree_icon\"\n" +
